...
<div class="content_main">
	<div class="alert alert-primary"><h1>Kaikki kanavat <a style="float: right;" href="./add_channel.php">+</a></h1></div>
	<div class="cat_cards">
		<div class="row">
	<?php
		require 'db.php';
		...
		while($row = $raw->fetch_assoc()){ ?>
			<div class="col">
				<div class="card" >
				  <a href="./play.php?live_url=<?php echo $row["live_url"] ?>"><img class="card-img-top" src="<?php echo $row['thumbnail'] ?>" alt="Card image cap"></a>
				  <div class="card-body">
